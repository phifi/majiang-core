 ...
 * 计算顺子的所有组合。
 * @param {string} s - 花色。
 * @param {Array} bingpai - 饼牌数组。
 * @param {number} n - 当前数字。
 * @return {Array} 顺子的所有组合。
 */
 ...
 * 计算一般和牌的面子。
 * @param {Object} shoupai - 手牌对象。
 * @param {string} hulepai - 和牌。
 * @return {Array} 一般和牌的面子。
 */
 ...
 * 计算和牌的所有面子。
 * @param {Object} shoupai - 手牌对象。
 * @param {string} rongpai - 荣牌。
 * @return {Array} 和牌的所有面子。
 */
 ...
 * 获取和牌的番种。
 * @param {Array} mianzi - 面子数组。
 * @param {Object} hudi - 和牌的基本信息。
 * @param {Array} pre_hupai - 和牌前的番种。
 * @param {Array} post_hupai - 和牌后的番种。
 * @param {Object} rule - 游戏规则。
 * @return {Array} 和牌的番种。
 */
 ...
 * @param {Object} shoupai - 手牌对象。
 * @param {string} rongpai - 荣牌。
 * @param {Array} baopai - 宝牌数组。
 * @param {Array} fubaopai - 副宝牌数组。
 * @return {Array} 和牌后的番种。
 */
